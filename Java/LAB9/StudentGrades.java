...
public class StudentGrades
{
    ...
    catch (IOException exception)
    {
		...
		for(Map.Entry<String, Student> entry : students.entrySet()){
			if(entry.getKey().equals("DD1234") || entry.getKey().equals("HH2123")){
				entry.getValue().updateGrade("CPS209", "B+");
			}
			else if(entry.getKey().equals("JJ2345")){
				entry.getValue().updateGrade("CPS209", "A-");
			}
		}
