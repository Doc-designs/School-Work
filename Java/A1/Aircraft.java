...
public class Aircraft implements Comparable<Aircraft>
{
  ...
  public Aircraft(int economy, int firstClass, String model)
  {
	 ...
	 */
	public int compareTo(Aircraft flight2){
		//Compares total # of seats, if flight1 has more, return 1, if they're the same return 0, else return -1
		if(this.getTotalSeats() > flight2.getTotalSeats()){
			return 1;
		}
		else if(this.getTotalSeats() == flight2.getTotalSeats()){
			return 0;
		}
		return -1;
	}
