...
public class Address
{
	...
	public boolean equals(Object other)
	{
		...
		if(((this.province == otherA.province)&&(this.city == otherA.city)&&(this.street == otherA.street)&&(this.streetNumber == otherA.streetNumber))&& this.apartment == otherA.apartment){
			return true;
		}
		else{
			return false;
